...
# Trace application
#ovs-appctl ofproto/trace ovs-synproxy in_port=1,tcp,dl_src=00:00:00:00:00:01,dl_dst=00:00:00:00:00:04,nw_src=1.1.1.1,nw_dst=195.148.125.201,tcp_dst=81,tcp_src=12345 -
